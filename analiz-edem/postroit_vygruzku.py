...
ws['A3']='Отбор: любое упоминание «Эдем» — серия «Эдем-1» в колонке C «Тип, марка» либо поставщик ООО «Эдем-Мебель» в колонке E.'
...
# ---------------- 5. ЧТО ПРОВЕРИТЬ ----------------
ws5=wb.create_sheet('Что проверить')
ws5['A1']='ЭДЕМ-МЕБЕЛЬ — ЗАМЕЧАНИЯ К ПРОВЕРКЕ'
ws5['A1'].font=Font(name=F,size=13,bold=True)
head(ws5,['№','Замечание','Где смотреть','Влияние'],[6,86,44,40],row=3)
items=[
 ('1','Вся мебель серии «Эдем-1» идёт без цены: 63 строки, 87 шт, колонка H пустая → сумма 0 руб. Это единственная крупная непроценённая группа в разделе ТХ.2.','Спецификация, строки 2519–3863; лист «Свод», блок А','Стоимость раздела ТХ.2 занижена на всю мебель «Эдем-1»'),
 ('2','Поставщик написан в двух вариантах: «ООО «Эдем- мебель»» (2 строки) и «ООО «Эдем- Мебель»» (15 строк). Плюс лишний пробел после дефиса в обоих вариантах.','Спецификация, колонка E, строки 2984, 2985 vs остальные 15','Ломается группировка/сводные по поставщику'),
 ('3','Одни и те же позиции «Эдем-1» в разных помещениях имеют разного поставщика: где-то «ООО «Эдем-Мебель»», где-то обезличенное «Торговая сеть Россия» (52 строки из 63).','Спецификация, колонка E; лист «Все строки Эдем»','Непонятно, кто реально поставляет мебель; риск двойного счёта'),
 ('4','У поставщика «ООО «Эдем-Мебель»» проценены только не-эдемовские позиции: стул Gigant GCH-01 (BL) — 1950 руб. и кресло Prestige GTP New — 12 000 руб. Итого 29 550 руб. Сама мебель «Эдем-1» у этого же поставщика — без цены.','Спецификация, строки 2985, 3291, 3433, 3435, 3518, 3673','Цена есть только на 10 шт из 97'),
 ('5','Два варианта написания одного наименования: «Стол рабочий прямой; 1200х700х750 (h) мм» (5 строк, 9 шт, без артикула) и «Стол рабочий прямой; 1200х700х750(h) мм» (1 строка, 1 шт, арт. Э-21.0). Лист «Сверка ТХ.2» отдельно помечает: «нет прямой пары в ВОРе — проверить».','Спецификация, строка 3276 и строки без артикула; лист «Сверка ТХ.2»','Позиция может не сойтись с ВОР / задвоиться'),
 ('6','Строка 3252: артикул записан как «+ ЭВ*2 Серия «Эдем-1», арт.Э-26.7» — обрывок от соседней позиции приклеился в начало.','Спецификация, строка 3252, колонка C','Мусор в артикуле, не найдётся поиском'),
 ('7','Количества по всем позициям «Эдем-1» с ВОР сходятся: м38 28/28, м17 23/23, м33 16/16, м83 12/12, м39 6/6, М84 1/1. Расхождений нет — вопрос только в цене.','Лист «Сверка с ВОР»','Подтверждено: править нужно цены, не объёмы'),
 ('8','На листе «Правки» по всем 69 строкам «Эдем» зафиксировано 52 правки, и все — только приведение «Шт.»/«шт» к «шт.». Цены никто не трогал.','Лист «Правки» книги-источника','История правок подтверждает: цены не заводились'),
]
r=4
for it in items:
